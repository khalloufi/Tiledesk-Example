...
struct WebView: UIViewRepresentable, WebViewHandlerDelegate {
    ...
    func updateUIView(_ webView: WKWebView, context: Context) {
        if url == .localUrl {
            ...
            if let url = URL(string: "https://widget.tiledesk.com/v5/assets/twp/index.html?tiledesk_projectid=62d7c7d4c4194e001c968913&tiledesk_fullscreenMode=true&tiledesk_hideHeaderCloseButton=true&tiledesk_isOpen=true") {
